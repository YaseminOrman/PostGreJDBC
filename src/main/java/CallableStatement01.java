...
public class CallableStatement01 {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        String sql3 = "create or replace function addF(n1 numeric ,n2 numeric ,n3 numeric) returns numeric language plpgsql as $$ begin return n1+n2+n3; end $$";
        st.execute(sql3);

        CallableStatement cst3 = con.prepareCall("{ ? = call addF(?, ?, ?) }");
        ...
        System.out.println(cst3.getObject(1));
